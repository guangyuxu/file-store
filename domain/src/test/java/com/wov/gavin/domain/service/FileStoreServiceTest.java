...
public class FileStoreServiceTest {
    ...
    private static final String fileUploadPath = System.getProperty("user.home") + "/wov/gavin/file-store/test";
    ...
    public void test_delete_file_non_exist() {
        ...
        Exception exception = assertThrows(FileNotExistException.class, () -> service.deleteFile(fileName));
